        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
                ...
                <CardContent className="p-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:info@kyairconsulting.com" className="text-muted-foreground hover:text-accent transition-colors">
                        info@kyairconsulting.com
                      </a>
                    </div>
                  </div>
                </CardContent>
              ...
              <Card className="bg-gradient-to-r from-[hsl(var(--gradient-start))] via-[hsl(var(--gradient-purple))] to-[hsl(var(--gradient-blue))] border-0">
