...
const services = [
  {
    ...
    description: "Expert guidance on implementing AI solutions tailored to your business. We analyze operations and recommend tools that drive efficiency."
  },
  {
    icon: Cog,
    title: "AI Automation & Integration",
    description: "Streamline workflows with intelligent automation. Integrate AI-powered tools that eliminate repetitive tasks and boost productivity."
  },
  {
    icon: TrendingUp,
    title: "AI Advertising Optimization",
    description: "Maximize advertising ROI with AI-driven campaign management. Data-driven strategies that optimize targeting and performance."
  },
  {
    icon: BarChart3,
    title: "Analytics & Data Insights",
    description: "Transform raw data into actionable intelligence. AI analytics solutions for smarter, faster decisions."
  },
  {
    icon: Monitor,
    title: "IT Support & Technical Services",
    description: "Comprehensive IT support for New Jersey businesses. System implementation, troubleshooting, and ongoing maintenance."
  },
  {
    icon: Zap,
    title: "Business Workflow Automation",
    description: "Automate business processes to save time and reduce errors. Custom solutions adapted to your operational needs."
  }
];

const testimonials = [
  {
    quote: "Kyair's AI consulting helped us automate our lead qualification process, boosting marketing efficiency by 30%.",
    author: "Sarah Johnson",
    role: "Marketing Director, TechCorp"
  },
  {
    quote: "Their AI advertising optimization strategies delivered a 150% increase in qualified leads while reducing ad spend.",
    author: "Michael Chen",
    role: "CEO, GrowthLabs"
  },
  {
...
const stats = [
  { value: "30%+", label: "Efficiency Increase", description: "AI automation reduces manual work and boosts productivity." },
        ...
        <div className="container mx-auto max-w-5xl">
          <div className="text-center space-y-8 animate-fade-in">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              We help businesses implement AI automation, integrate intelligent tools, and optimize performance using data‑driven strategies.
            </p>
        ...
        <div className="container mx-auto max-w-3xl">
          <header className="text-center mb-16">
            ...
            <p className="text-muted-foreground">
              Common questions about AI consulting, automation, and IT support.
            </p>
          </header>
